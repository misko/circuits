...
## v1.7 — 2026-07-17
Released: 07_releases/v1.7-2026-07-17/
- GND pins draw standard power-symbol ground icons (46) instead of GND
  ...
  at 0. Rails (5V/3V3) stay labels by design.
- Netlist node-for-node identical (parity 0, 61 nets/214 nodes); ERC 0
  total; policy_audit zero FAIL; S-OCCL 0 (icons are not text).
- Fab byte-identical to v1.1-v1.6. Supersedes v1.6.
