# ORDER_README — esp32-laser-timing v1.1 (JLCPCB)
...
v1.1 is a **silkscreen fix**: every component reference designator (U2, R3,
...
- **Order v1.1, not v1.0.** v1.0 is superseded (see its SUPERSEDED.md).
