...
| S-OCCL | PASS | 0 text occlusions (<= 0); 1015/1015 drawable objects placed |
...
| M-REL | PASS | cooksense-v1.7-2026-07-30: provenance + hashes verify (board 'cooksense': 7 of 9 release dir(s) in 07_releases) |
| M-BOM | PASS | 07_releases/cooksense-v1.7-2026-07-30/fab/bom.csv (SEALED, and still contemporaneous with source): every LCSC == source (208 coded) |
| A-POP | PASS | cooksense-v1.7-2026-07-30: A-POP: PASS (every unpopulated part is declared with evidence) |
| M-DEPEND | PASS | M-DEPEND coverage: 374 coded row(s) across 7 sealed release(s) — 374 GRADED, 0 WAIVED (release-internal map, blank cell), 0 PINNED-AND-DISAGREEING (F-MPN's), 0 FAIL |
| A-BODY | PASS | cooksense-v1.7-2026-07-30: bodies mounted 206/206 (generated) |
