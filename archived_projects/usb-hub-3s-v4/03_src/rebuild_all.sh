...
BOARD=usb_hub_3s_v4                            # <board> stem for 04_kicad/<board>.*
TSX=usb_hub_3s_v4                              # 03_tscircuit/src/<TSX>.tsx basename
SCHEMATIC_TITLE="USB HUB 3S V4"                # human PDF title
# ----------------------------------------------------------------------------
...
# [0d] Source-only schema battery. Fail cheap before invoking tscircuit.
...
$PY "$S/early_design_check.py" . \
    || { echo "GATE FAILED [1b] D-SPEC/E-PATH/E-SWDRV/E-SURGE/E-CAP/E-FAULT: commission boundary, complete delivery path, switching drive, surge coordination, effective capacitance, or aggregate fault coordination is not proven"; exit 1; }
...
# [4c2] Exact refilled placement DRC. Ratsnest opens and preliminary isolated
# zones are expected here; ordinary violations and parity findings are not.
