...
2-layer JLC standard tier: 0.6/0.3 vias, 0.127 track/space capability floor."""
import json
import sys
...
for c in classes:
    c["clearance"] = 0.127  # JLC 2L floor; router grades to 0.15 nominal
ns["classes"] = classes
