// Four-port self-powered USB 2.0 debug hub. USB-C DATA is upstream USB 2.0
// data and VBUS sense only. USB-C POWER is a hardware-configured 15 V PD sink
// feeding a local 5 V / 6 A regulator. One internal downstream port is a
...
export default () => <board width="500mm" height="350mm" routingDisabled>
  <schematicsheet name="pd_power"
    displayName="USB-C POWER — 15 V PD sink, input protection and 5 V / 6 A regulator" sheetIndex={1} />
  <schematicsheet name="power"
    displayName="POWER DISTRIBUTION — aggregate eFuse, USB bulk bank and 3.3 V buck" sheetIndex={2} />
  ...
  <group name="pd_input_5v_and_3v3" pcbX="-150mm" pcbY="100mm">
    ...
    <C name="C_PD_OUT1" value="22uF" a="P5V_REG" b="GND" jlc="C21397" fp="1210" />
    ...
    <C name="C_BUCK_OUT1" value="22uF" a="N3V3_MAIN" b="GND" jlc="C55530" fp="1210" />
    <C name="C_BUCK_OUT2" value="22uF" a="N3V3_MAIN" b="GND" jlc="C55530" fp="1210" />
  </group>
