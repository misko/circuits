...
- courtyards drawn (F.CrtYd): **166**; footprints with no courtyard on EITHER layer: 0
- **COVERAGE: 34 measured / 159 refs with an expected body** (125 unresolvable, 0 resolvable but NOT measured, 0 with no JLC model at all)
...
|---|---|---|---|---|---|---|---|
| `J_DATA` | C165948 | 0deg @0.00mm | 0.364 | 0.000 | -0.03,-0.11,-0.65,-0.16 | 3196 | 1.740 |
| `J_POWER` | C165948 | 0deg @0.00mm | 0.354 | 0.000 | -0.03,-0.02,-0.65,-0.20 | 3150 | 1.740 |
...
## Not measurable by construction (125) — named, never silently passed
...
- `C_PD_IN_HF` — body 1.00x0.50 mm is under the 2.0 mm resolvability floor (3.7 px, and erosion costs 4 px)
...
- `D_PD_TVS` — body 1.65x3.75 mm is under the 2.0 mm resolvability floor (12.2 px, and erosion costs 4 px)
