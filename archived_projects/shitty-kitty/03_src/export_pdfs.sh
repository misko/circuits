...
kicad-cli sch export pdf -o "$OUT/schematic.pdf" 04_kicad/shitty_kitty.kicad_sch >/dev/null
...
kicad-cli pcb export pdf --mode-multipage \
    ...
    -o "$OUT/pcb_layers.pdf" 04_kicad/shitty_kitty.kicad_pcb >/dev/null
...
kicad-cli pcb export pdf --mode-single \
    ...
    -o "$OUT/assembly_top.pdf" 04_kicad/shitty_kitty.kicad_pcb >/dev/null
