# Final red-team layout review — USB Controlled Debug Hub v0.1.3 sourcing supersede
...
The v0.1.3 sourcing gate proves that the PCB, CPL, Gerbers and drills are
identical to v0.1.2. The layout verdict therefore carries forward unchanged;
only supplier identities move. The package may enter JLC's uploader; allocation
and preview approval remain mandatory before payment.
