...
BOARD=pi_usb_port_switch                       # 04_kicad/<board>.* stem
TSX=pi_usb_port_switch                         # 03_tscircuit/src/<TSX>.tsx basename
SCHEMATIC_TITLE=PI_USB_PORT_SWITCH             # human PDF title
# ----------------------------------------------------------------------------
