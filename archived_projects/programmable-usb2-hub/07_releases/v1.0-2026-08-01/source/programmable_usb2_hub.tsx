...
const Buck = ({ s, vout, vin = "VIN", ids, fbsense, en, fbtop, fbtopMpn }: {
  s: string; vout: string; vin?: string; fbsense?: string; en?: string; fbtop: string; fbtopMpn?: string;
  ids: {
  ...
  return (
    <group name={`buck${s}`}>
      ...
      <chip name={ids.QH} supplierPartNumbers={{ jlcpcb: ["C404363"] }}
        ...
        connections={{ pin1: n("SW"), pin2: n("SW"), pin3: n("SW"), pin4: n("HO"), pin5: `net.${vin}`, pin6: `net.${vin}`, pin7: `net.${vin}`, pin8: `net.${vin}` }}
        footprint={<Dfn56 />} />
      <chip name={ids.QL} supplierPartNumbers={{ jlcpcb: ["C404363"] }}
        pinLabels={{ pin1: "S1", pin2: "S2", pin3: "S3", pin4: "G", pin5: "D5", pin6: "D6", pin7: "D7", pin8: "D8" }}
        connections={{ pin1: n("CS"), pin2: n("CS"), pin3: n("CS"), pin4: n("LO"), pin5: n("SW"), pin6: n("SW"), pin7: n("SW"), pin8: n("SW") }}
        footprint={<Dfn56 />} />
      <resistor name={ids.RS} resistance="0.01" footprint="2512" supplierPartNumbers={{ jlcpcb: ["C844901"] }}
      ...
      {/* input caps 4x 10uF/50V X7R 1210 (Samsung CL32B106KBJNNWE C3844168) + 100n */}
      {ids.CIN.map((c) => (
        <capacitor key={c} name={c} capacitance="10uF" footprint="1210" supplierPartNumbers={{ jlcpcb: ["C3844168"] }} connections={{ pin1: `net.${vin}`, pin2: "net.GND" }} />
      ))}
      <capacitor name={ids.CINH} capacitance="100nF" footprint="0603" connections={{ pin1: `net.${vin}`, pin2: "net.GND" }} />
      {/* output caps 4x 100uF/10V X5R 1210 (Samsung CL32A107MPVNNNE C23742) */}
      {ids.COUT.map((c) => (
        <capacitor key={c} name={c} capacitance="100uF" footprint="1210" supplierPartNumbers={{ jlcpcb: ["C23742"] }} connections={{ pin1: `net.${vout}`, pin2: "net.GND" }} />
      ))}
...
// ---------------------------------------------------------------------------
// Programmable 4-port USB 2.0 hub.  The legacy board above is retained only as
// the audited source of the proven LM5116 cell; it is never instantiated.
...
const R2 = ({ name, value, a, b, fp = "0603" }: any) =>
  <resistor name={name} resistance={value} footprint={fp} connections={{ pin1: `net.${a}`, pin2: `net.${b}` }} />
...
const PortCell = ({ p, efuse, mux, esd, jack, rail, adcV, adcI }: any) => {
  ...
  return (
    <group name={`port${p}`}>
      ...
      <R2 name={`R${base + 0}`} value="100k" a={N("PWR_EN")} b="GND" />
      ...
      <R2 name={`R${base + 4}`} value="976" a={N("ILIM")} b="GND" />
      <C2 name={`C${base + 0}`} value="3.3nF" a={N("DVDT")} b="GND" />
      ...
      {/* TI recommends a local OUT-to-GND Schottky clamp for cable/lead
          inductance.  Cathode is on VBUS so ordinary operation reverse-biases
          it; a negative unplug transient is clamped at the eFuse output. */}
      <chip name={`D${p + 3}`} supplierPartNumbers={{ jlcpcb: ["C85098"] }}
        pinLabels={{ pin1: "K", pin2: "A" }}
        connections={{ pin1: `net.${N("VBUS")}`, pin2: "net.GND" }}
        footprint={<Pol2 w="2.0mm" h="2.3mm" dx="2.4mm" />} />
      ...
      <chip name={mux} supplierPartNumbers={{ jlcpcb: ["C11355"] }}
        ...
        footprint={<TwoSided pins={10} pitch={0.5} span={3.4} />} />
      ...
      <chip name={esd} supplierPartNumbers={{ jlcpcb: ["C7519"] }}
        ...
        footprint="sot23_6" />
      {/* Exact MPN is used as the converter handle because this consigned part
          has no LCSC code; assembly.yaml, not this handle, owns procurement. */}
      <chip name={jack} supplierPartNumbers={{ jlcpcb: ["USB1130-15-A"] }}
...
export default () => (
  <board width="130mm" height="90mm" routingDisabled>
    ...
    <chip name="Q1" supplierPartNumbers={{ jlcpcb: ["C454269"] }}
      pinLabels={{ pin1: "S", pin2: "S", pin3: "S", pin4: "G", pin5: "D5", pin6: "D6", pin7: "D7", pin8: "D8" }}
      connections={{ pin1: "net.VIN_FUSED", pin2: "net.VIN_FUSED", pin3: "net.VIN_FUSED", pin4: "net.DGATE", pin5: "net.FET_MID", pin6: "net.FET_MID", pin7: "net.FET_MID", pin8: "net.FET_MID" }} footprint={<Dfn56 />} />
    <chip name="Q2" supplierPartNumbers={{ jlcpcb: ["C454269"] }}
      pinLabels={{ pin1: "S", pin2: "S", pin3: "S", pin4: "G", pin5: "D5", pin6: "D6", pin7: "D7", pin8: "D8" }}
      connections={{ pin1: "net.VIN_PROTECTED", pin2: "net.VIN_PROTECTED", pin3: "net.VIN_PROTECTED", pin4: "net.HGATE", pin5: "net.FET_MID", pin6: "net.FET_MID", pin7: "net.FET_MID", pin8: "net.FET_MID" }} footprint={<Dfn56 />} />
    ...
    <R2 name="R1" value="88.7k" a="VIN_FUSED" b="OV_TOP" />
    <R2 name="R2" value="0" a="OV_TOP" b="OV_SENSE" />
    <R2 name="R3" value="4.75k" a="OV_SENSE" b="GND" />
    ...
    <chip name="D1" supplierPartNumbers={{ jlcpcb: ["C315992"] }} pinLabels={{ pin1: "K", pin2: "A" }}
      connections={{ pin1: "net.VIN_PROTECTED", pin2: "net.GND" }} footprint={<Pol2 w="2.1mm" h="2.4mm" dx="2.2mm" />} />

    <Buck s="A" vin="VIN_PROTECTED" vout="N5V_A" fbtop="3.92k" fbtopMpn="C728591" ids={{
      U: "U2", QH: "Q3", QL: "Q4", RS: "RS1", L: "L1", DB: "D2",
      RT: "R101", FBT: "R102", FBB: "R103", RCMP: "R104", UVT: "R105", UVB: "R106", REN: "R107", RCSK: "R108", RCSG: "R109",
      CRAMP: "C101", CCMZ: "C102", CCMP: "C103", CSS: "C104", CBOOT: "C105", CVCC: "C106", CIN: ["C107", "C108", "C109", "C110"], CINH: "C111", COUT: ["C112", "C113", "C114", "C115"], RSNB: "R110", CSNB: "C116",
    }} />
    <Buck s="B" vin="VIN_PROTECTED" vout="N5V_B" fbtop="3.92k" fbtopMpn="C728591" ids={{
      U: "U3", QH: "Q5", QL: "Q6", RS: "RS2", L: "L2", DB: "D3",
      RT: "R201", FBT: "R202", FBB: "R203", RCMP: "R204", UVT: "R205", UVB: "R206", REN: "R207", RCSK: "R208", RCSG: "R209",
      CRAMP: "C201", CCMZ: "C202", CCMP: "C203", CSS: "C204", CBOOT: "C205", CVCC: "C206", CIN: ["C207", "C208", "C209", "C210"], CINH: "C211", COUT: ["C212", "C213", "C214", "C215"], RSNB: "R210", CSNB: "C216",
    }} />

    {/* Always-on logic buck. */}
    ...
    <inductor name="L3" inductance="4.7uH" supplierPartNumbers={{ jlcpcb: ["C307880"] }} footprint="inductor_6mm" connections={{ pin1: "net.SW_3V3", pin2: "net.N3V3_LOGIC" }} />
