...
ANCHOR = {
    ...
    "TP6": (64.0, 52.8, 0), "R15": (69.5, 52.8, 0),
    ...
    "R6": (99.0, 73.5, 0), "R7": (105.5, 73.5, 0),
    "R8": (99.0, 77.0, 0), "R9": (105.5, 77.0, 0),
    # mic conditioning close to +IN_A (short AIN, low-Z MIC runs east)
    "C3": (108.5, 70.0, 0), "R3": (108.5, 74.0, 0), "R2": (124.0, 66.0, 0),
...
SILK = [
    ...
    # beeper block
    ("BEEPER", 72.0, 78.6, 0.7), ("FLYBACK", 87.0, 81.0, 0.6),
    ("TVS DNP", 86.9, 86.0, 0.6),
    # mic
    ("MIC PADS", 139.5, 66.2, 0.7), ("MIC+", 135.8, 70.5, 0.6),
    ("MIC-", 135.8, 73.04, 0.6),
    # TPs
    ("SHIELD", 64.0, 54.7, 0.6), ("AUD+", 75.0, 54.7, 0.6),
