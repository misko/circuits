# ORDER_README — esp32-laser-timing v1.6 (JLCPCB)
...
v1.6 is a **silkscreen fix**: every component reference designator (U2, R3,
...
- **Order v1.6, not v1.0.** v1.0 is superseded (see its SUPERSEDED.md).
...
v1.6 is the current record.

## v1.6 vs v1.2/v1.1 (render correction)
v1.6 restores the CORRECT J1 USB-C render that v1.1 already had. v1.2
...
byte-identical across v1.1/v1.2/v1.6** — the physical board never changed
(J1 pads always fit JLC's CAD at 0.00mm). Order v1.6 (or v1.1); do not use
v1.2's render.
...
byte-identical to v1.3/v1.2/v1.1 — order any; v1.6 is the current record.
