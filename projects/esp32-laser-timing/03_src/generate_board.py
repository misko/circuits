...
ANCHOR = {
    ...
    "Q1": (63.0, 99.0, 0), "Q2": (71.5, 99.0, 0), "Q3": (80.0, 99.0, 0),
    ...
    "R20": (96.0, 99.2, 0), "R21": (104.5, 99.2, 0), "R22": (113.0, 99.2, 0),
    ...
    "C6": (98.5, 81.0, 0),
    # test points
    "TP1": (123.4, 80.5, 0), "TP2": (123.4, 86.0, 0), "TP3": (123.4, 91.5, 0),
...
SILK = [
    # channel names + per-pin words sit ABOVE/BESIDE the terminal bodies so
    # they stay readable with the terminals mounted (bodies start y=103.4 /
    # x=133.6; pin words at the PAD x positions)
    ("LASER 1", 63.2, 101.4, 0.8), ("LASER 2", 71.7, 101.4, 0.8), ("LASER 3", 80.2, 101.4, 0.8),
    ("PHOTODIODE 1", 98.7, 101.4, 0.7), ("PHOTODIODE 2", 107.2, 101.4, 0.7), ("PHOTODIODE 3", 115.7, 101.4, 0.7),
    ("5V", 61.5, 102.9, 0.6), ("SW", 65.0, 102.9, 0.6),
    ("5V", 70.0, 102.9, 0.6), ("SW", 73.5, 102.9, 0.6),
    ("5V", 78.5, 102.9, 0.6), ("SW", 82.0, 102.9, 0.6),
    ("5V", 97.0, 102.9, 0.6), ("PD", 100.5, 102.9, 0.6),
    ("5V", 105.5, 102.9, 0.6), ("PD", 109.0, 102.9, 0.6),
    ("5V", 114.0, 102.9, 0.6), ("PD", 117.5, 102.9, 0.6),
    # button terminal bodies span y-5.8..+2.3 around pad1; names go in the gaps
    ("BUTTON 1", 136.5, 70.3, 0.8), ("BUTTON 2", 136.5, 82.3, 0.8), ("BUTTON 3", 136.5, 94.3, 0.8),
    ("GND", 131.0, 62.5, 0.65), ("IN", 131.2, 66.0, 0.65),
    ("GND", 131.0, 74.5, 0.65), ("IN", 131.2, 78.0, 0.65),
    ("GND", 131.0, 86.5, 0.65), ("IN", 131.2, 90.0, 0.65),
    # OLED header words + swapped-module warning (P8: prominent)
    ("GND", 121.6, 52.2, 0.7), ("VCC", 124.5, 52.2, 0.7),
    ("SCL", 127.1, 52.2, 0.7), ("SDA", 129.7, 52.2, 0.7),
    ...
    # test points
    ("COMP1", 123.4, 82.4, 0.6), ("COMP2", 123.4, 87.9, 0.6), ("COMP3", 123.4, 93.4, 0.6),
