# ORDER README — usb-hub-3s-v3 **v1.10** (internal board name `usb_hub_3s_v2`)
...
**NOT a USB hub, NOT USB-PD.** Release **v1.10-2026-07-27**.
...
```
bom_legibility_check.py 07_releases/v1.10-2026-07-27/fab/bom.csv \
