# redteam_topology — contract-named copy

> **PROVENANCE.** This is the CURRENT topology red-team for this board, shipped under the name
`07_releases/contracts.md` requires. It is a VERBATIM COPY of
`08_reviews/2026-07-22_v1.0_redteam_topology_rereview.md`, which remains in place.

Lineage, stated because "re-review" is otherwise ambiguous: the ORIGINAL topology
red-team is `08_reviews/2026-07-22_v1.0_redteam_topology.md`; this RE-REVIEW
supersedes it and is therefore the current one. The later
`08_reviews/2026-07-23_v1.2_redteam_protection.md` is a PROTECTION-cell review, not
a topology review, and is a different document — it is not the successor to this
one and does not replace it. The v1.2 discrete-protection redesign (ADR-0002) and
the v1.6 Pi-4 load correction (ADR-0004) both postdate this review; their reasoning
lives in those ADRs.
>
> Source: `08_reviews/2026-07-22_v1.0_redteam_topology_rereview.md` (sha256 in this release's MANIFEST under both names).
