> **RELEASE v1.4 — documentation-only supersede of v1.3.** The board is unchanged
> (still silk revision v1.3) and `fab/`, `source/`, `3d/`, `pdf/` are byte-identical
> to v1.3. Only the MANIFEST's assembly warning changed — it named the wrong notch
> bank. Everything this index describes is otherwise as it was in v1.3.
