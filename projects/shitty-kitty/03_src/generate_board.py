...
ANCHOR = {
    ...
    "J5": (176.0, 98.0, 270), "J6": (176.0, 110.5, 90),
    "R10": (166.5, 106.5, 0), "C17": (166.5, 109.5, 0), "R11": (166.5, 112.5, 0),
...
SILK = [
    ...
    *[(f"{n}", 100.0 + 2.54 * (n - 1), 51.2, 0.7) for n in range(1, 13)],
    ...
    ("MOTOR", 171.5, 91.5, 1.0),
    ("A1", 172.6, 94.3, 0.7), ("A2", 172.6, 96.8, 0.7),
    ("B1", 172.6, 99.3, 0.7), ("B2", 172.6, 101.8, 0.7),
    ("ENDSTOP", 170.5, 105.6, 0.9), ("SIG", 172.3, 108.8, 0.65), ("GND", 172.3, 112.3, 0.65),
