#!/usr/bin/env python3
"""Generate 04_kicad/crow_mic_pod.kicad_pcb from the netlist + floorplan.
...
NETLIST = HERE.parent / "06_build" / "netlists" / "crow_mic_pod.net"
PCB = K / "crow_mic_pod.kicad_pcb"
