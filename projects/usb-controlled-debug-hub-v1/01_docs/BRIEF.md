...
| C11 | Size USB2517I VBUS_DET as 47 kOhm over 100 kOhm so the detachable-host detector clears full-range voltage, tolerance, and leakage corners | agent (adversarial electrical review / P-delegation) | [0011](decisions/0011-vbus-det-full-corner-divider.md) |
