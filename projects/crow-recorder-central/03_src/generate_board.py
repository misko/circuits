#!/usr/bin/env python3
"""Generate 04_kicad/crow_recorder_central.kicad_pcb from the netlist + floorplan.
...
NETLIST = HERE.parent / "06_build" / "netlists" / "crow_recorder_central.net"
PCB = K / "crow_recorder_central.kicad_pcb"
...
def main():
    ...
    SILK = [
        ...
        ("crow-recorder-central v1.0", X0 + 88.0, Y1 - 2.5, 1.1),
    ]
    for n in range(1, 9):
