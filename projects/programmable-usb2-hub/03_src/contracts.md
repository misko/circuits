...
| `prep.seed_stubs.*` | `route_and_stitch_generic.py` | collision-checked deterministic copper placed on the track-free r0 before KRT; used when reviewed high-speed launches/layer assignments must be obstacles to every later wave |
