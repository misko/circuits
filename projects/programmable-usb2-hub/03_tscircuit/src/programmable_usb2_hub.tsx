...
export default () => (
  <board width="130mm" height="90mm" routingDisabled>
    ...
    <chip name="Q1" supplierPartNumbers={{ jlcpcb: ["C454269"] }}
      pinLabels={{ pin1: "S", pin2: "S", pin3: "S", pin4: "G", pin5: "D_COMMON" }}
      connections={{ pin1: "net.VIN_FUSED", pin2: "net.VIN_FUSED", pin3: "net.VIN_FUSED", pin4: "net.DGATE", pin5: "net.FET_MID" }} footprint={<Dfn56 />} />
    <chip name="Q2" supplierPartNumbers={{ jlcpcb: ["C454269"] }}
      pinLabels={{ pin1: "S", pin2: "S", pin3: "S", pin4: "G", pin5: "D_COMMON" }}
      connections={{ pin1: "net.VIN_PROTECTED", pin2: "net.VIN_PROTECTED", pin3: "net.VIN_PROTECTED", pin4: "net.HGATE", pin5: "net.FET_MID" }} footprint={<Dfn56 />} />
