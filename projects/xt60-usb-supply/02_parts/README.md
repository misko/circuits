...
| 2 | CL31B106KAHNNNE, CL10B104KB8NNNC, CL10A225KO8NNNC | Shared Samsung general MLCC catalog (Nov 2015, 84 pp), not per-part sheets | Samsung/LCSC serve the same catalog PDF for both codes; MPNs validated by decoding against the catalog's part-numbering table | Nothing — values verified against LCSC listings |
