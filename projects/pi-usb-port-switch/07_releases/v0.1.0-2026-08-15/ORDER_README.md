# ORDER README — Pi USB port switch v0.1.0
...
`source/` is the exact inspectable KiCad/TSX/netlist source with archive-local
custom footprint and model libraries. `pdf/` contains the human schematic,
