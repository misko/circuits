...
| `rf.yaml` | RF applicability, ports/cross-sections/performance claims, first-article plan, and exact-artifact RF schematic/PCB/fab review requirements; graded by `rf_contract_check.py` |
