// pluto-rx2-8way-v4 — an 8-element antenna selector for angle-of-arrival on an
// ADALM-PlutoPlus RX2, authored in tscircuit. P9 requires a pre-built RP2040
// module; ADR-0001 selects Waveshare RP2040-Zero under the module-first rule.
// Proven RF cells and measured placement constraints are intentionally reused,
// but this source is regenerated under the v4 brief and is the sole authority.
//
...
const MOD_JLC = "C9900173620" // footprint identity only; U_MCU is off the CPL.
// C99* is a permanently stock-zero JLC consignment placeholder, not a buyable
// line part. It is retained solely so the converter resolves the verified
...
// 03_src/lib/pluto_rx2_8way_v4.pretty/RP2040_Zero_LCC23_18x23.5.kicad_mod:
...
export default () => (
  <board width="50mm" height="68mm" routingDisabled>
    ...
    {/* ================================================================
        ...
        Waveshare RP2040-Zero, USER-FITTED (ADR-0002): no Pico-class RP2040
        module is machine-placeable from JLC stock, and the vendor STEP shows
        carrier-facing components prevent direct reflow seating. U_MCU is off
        the CPL and has no paste; the builder fits it after carrier assembly.
