# USB-Controlled Debug Hub 2A v1 — v0.1.1

**DO NOT ORDER YET.**

DESIGN: PASS candidate — exact local design gates are green. This revision
adds complete USB route contracts, repairs the realized USB routing/reference
planes, and makes the four manual USB-A position-file exclusions source-owned.
