# USB-Controlled Debug Hub 2A v1 — v0.1.2

**DO NOT ORDER YET.**

DESIGN: PASS candidate — exact local design gates are green. This ordinary
full successor preserves the exact v0.1.1 board and fabrication payload while
making its three reused footprints project-local and its KiCad library paths
clone-portable. It supersedes `v0.1.1-2026-08-21` for source closure only; it
does not change copper, placement, routing, BOM, CPL, or electrical intent.
...
3. Paste `fab/order_notes.txt` verbatim. Confirm 611 protected 0.46/0.20 mm
