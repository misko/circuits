# Final topology red-team — v0.1.1
...
parity are 0/0/0; route acceptance has all 8 required predicates PASS and one
declared RF N-A; the policy audit has zero FAIL;
