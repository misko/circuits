...
- The programming connector and its pinout belong in `docs/ARCHITECTURE.md`;
  reference it, do not restate it.

## Validate

- MCU target is a variable and matches the part in the BOM / `parts/`
- host tests pass
...
- Hardcoded MCU → parameterize; cross-check against `parts/`.
