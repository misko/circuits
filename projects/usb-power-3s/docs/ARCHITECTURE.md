...
protection. Machine-enforced net facts live in `../src/rules/nets.yaml`.
...
Index only — the source is `src/rules/nets.yaml`.
...
|---|---|---|---|
| J1 | XT60PW-M | 3S in | **pad 1 = "−" blade, pad 2 = "+"** — `parts/XT60PW-M/part.yaml` |
