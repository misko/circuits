...
|---|---|---|---|---|---|---|---|
| `J9` | C429844 | NONE (best 1.80mm) -> JLC's own transform | 0.262 | 0.095 | +0.05,-0.09,+0.43,-0.12 | 8292 | 5.942 |
| `J10` | C429844 | NONE (best 1.80mm) -> JLC's own transform | 0.233 | 0.095 | +0.02,-0.09,+0.39,-0.12 | 8275 | 5.942 |
| `J5` | C429844 | NONE (best 1.80mm) -> JLC's own transform | 0.210 | 0.011 | -0.01,-0.40,-0.06,-0.01 | 8056 | 5.942 |
| `J1` | C5184243 | 0deg @0.00mm | 0.208 | 0.004 | -0.34,-0.00,+0.34,+0.42 | 14050 | 2.133 |
| `J2` | C429844 | NONE (best 1.80mm) -> JLC's own transform | 0.205 | 0.095 | -0.01,-0.09,+0.36,-0.12 | 8287 | 5.942 |
| `J7` | C429844 | NONE (best 1.80mm) -> JLC's own transform | 0.190 | 0.011 | +0.06,-0.01,+0.01,+0.38 | 8288 | 5.942 |
| `J3` | C429844 | NONE (best 1.80mm) -> JLC's own transform | 0.178 | 0.095 | -0.04,-0.09,+0.33,-0.12 | 8309 | 5.942 |
| `J6` | C429844 | NONE (best 1.80mm) -> JLC's own transform | 0.159 | 0.037 | -0.01,-0.35,-0.06,+0.04 | 8078 | 5.942 |
| `J8` | C429844 | NONE (best 1.80mm) -> JLC's own transform | 0.139 | 0.058 | +0.06,-0.06,+0.01,+0.33 | 8311 | 5.942 |
...
- `J4` — a part with NO expected body — so nothing this gate can mask out — sits within 0.5 mm: H1 (0.40 mm); the two would merge into one component
...
| `J10` | **MOUNT-FALLBACK** | best 1.80mm at 0deg, over 0.5mm — body mounted at JLC's OWN footprint transform (offset 0, their model rot_z), NOT at the failed fit. The render is therefore what JLC's own CAD says, and is  |
...
| `J2` | **MOUNT-FALLBACK** | best 1.80mm at 0deg, over 0.5mm — body mounted at JLC's OWN footprint transform (offset 0, their model rot_z), NOT at the failed fit. The render is therefore what JLC's own CAD says, and is  |
...
| `J3` | **MOUNT-FALLBACK** | best 1.80mm at 0deg, over 0.5mm — body mounted at JLC's OWN footprint transform (offset 0, their model rot_z), NOT at the failed fit. The render is therefore what JLC's own CAD says, and is  |
...
| `J4` | **MOUNT-FALLBACK** | best 1.80mm at 0deg, over 0.5mm — body mounted at JLC's OWN footprint transform (offset 0, their model rot_z), NOT at the failed fit. The render is therefore what JLC's own CAD says, and is  |
...
| `J5` | **MOUNT-FALLBACK** | best 1.80mm at 0deg, over 0.5mm — body mounted at JLC's OWN footprint transform (offset 0, their model rot_z), NOT at the failed fit. The render is therefore what JLC's own CAD says, and is  |
...
| `J6` | **MOUNT-FALLBACK** | best 1.80mm at 0deg, over 0.5mm — body mounted at JLC's OWN footprint transform (offset 0, their model rot_z), NOT at the failed fit. The render is therefore what JLC's own CAD says, and is  |
...
| `J7` | **MOUNT-FALLBACK** | best 1.80mm at 0deg, over 0.5mm — body mounted at JLC's OWN footprint transform (offset 0, their model rot_z), NOT at the failed fit. The render is therefore what JLC's own CAD says, and is  |
...
| `J8` | **MOUNT-FALLBACK** | best 1.80mm at 0deg, over 0.5mm — body mounted at JLC's OWN footprint transform (offset 0, their model rot_z), NOT at the failed fit. The render is therefore what JLC's own CAD says, and is  |
...
| `J9` | **MOUNT-FALLBACK** | best 1.80mm at 0deg, over 0.5mm — body mounted at JLC's OWN footprint transform (offset 0, their model rot_z), NOT at the failed fit. The render is therefore what JLC's own CAD says, and is  |
