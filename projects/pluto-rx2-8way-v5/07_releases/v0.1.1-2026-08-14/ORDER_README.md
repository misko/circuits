...
This v0.1.1 docs-only archive supersedes `v0.1.0-2026-08-13` solely to
correct structured publication metadata and canonical project identity in two
exact-board review subjects. Its `fab/`, `source/` and `3d/` payloads are
byte-identical to v0.1.0. No schematic, PCB, footprint, part, placement,
