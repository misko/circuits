# Pluto RX2 eight-way v5 enclosure v0.3.0
...
4. Confirm both M3 inserts install without boss damage and the adapter seats
   flat without pinching the antenna or cable.
5. Perform the normal board drop-in and simultaneous interface-mating tests.
