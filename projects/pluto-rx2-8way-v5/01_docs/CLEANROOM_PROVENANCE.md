...
| ST DS13866 Rev 5 official local bytes (Rev 3 retained as history) | STM32C011F4P6 TSSOP-20 pinout, supply, HSI48 error, BOR, watchdog, SWD, decoupling and package | Exact current controller interface; focused Rev 3-to-Rev 5 comparison found no consumed-value change |
